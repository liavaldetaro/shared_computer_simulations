...
def main():
    ...
    with open('beam'+ str(int(E_probeam))+'.txt', 'w') as text_file:
        ...
        print("s:Sc/LET_f/Quantity                             = \"ProtonLET\"", file=text_file)
        print("s:Sc/LET_f/WeightBy                             = \"Track\"", file=text_file)
        print("s:Sc/LET_f/Component                            = \"Patient\"", file=text_file)
        print("s:Sc/LET_f/IfOutputFileAlreadyExists            = \"Overwrite\"", file=text_file)
        print("s:Sc/LET_f/OutputFile                           = \"{}mev_output/let\"".format(int(E_probeam)), file=text_file)
        print("\n \n", file=text_file)
